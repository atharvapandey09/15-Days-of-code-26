...
- Solved two questions based on BS on 2D arrays
    1.Find row with maximum 1's [LINK](https://takeuforward.org/arrays/find-the-row-with-maximum-number-of-1s)
    2.Search in a 2D matrix [Profile link](https://leetcode.com/u/Atharva9_P/)
